const dictionaries = {
  fr: {
    ...
    commands: {
      ...
      sensitiveCommandDeniedAdminOnly: "Seuls les administrateurs peuvent utiliser cette commande sensible.",
      sensitiveCommandDeniedWithRole: "Seuls les administrateurs ou le rôle {role} peuvent utiliser cette commande sensible.",
      giveMoneyInvalidAmount: "Le montant doit être un entier positif.",
      giveMoneyBot: "Tu ne peux pas donner de l'argent à un bot.",
      giveMoneyRecipientMaxBalance: "Le destinataire a atteint la balance maximum autorisée.",
      giveMoneyEconomyDisabled: "L'économie est désactivée sur ce serveur.",
      giveMoneyRecipientBalance: "Balance du destinataire",
      addMoneySuccessTitle: "Argent ajouté",
      addMoneySuccessBody: "Tu as ajouté **{amount} {emoji}** à {user}.",
      addMoneyFailed: "Impossible d'ajouter l'argent pour le moment."
    },
    daily: {
    ...
    vote: {
      linkTitle: "Voter sur Top.gg",
      linkBody: "Soutiens EcoBoty en votant, puis utilise `/vote claim` sur ce serveur pour récupérer ta récompense.\n{url}",
      openButton: "Voter sur Top.gg",
      reward: "Récompense de base",
      status: "Statut",
      statusClaimable: "Récompense disponible — `/vote claim`",
      statusNeedVote: "Pas encore de vote à récupérer",
      needTitle: "Vote requis",
      needBody: "Vote d’abord sur Top.gg, puis reviens claim ici.\n{url}",
      alreadyTitle: "Déjà récupéré",
      alreadyBody: "Tu as déjà récupéré la récompense de ton dernier vote sur un serveur.",
      expiredTitle: "Vote expiré",
      expiredBody: "Ton vote n’est plus valide. Vote à nouveau sur Top.gg.\n{url}",
      disabledTitle: "Récompenses désactivées",
      disabledBody: "Les récompenses Top.gg sont temporairement désactivées.",
      claimedTitle: "Récompense Top.gg",
      claimedBody: "Tu as reçu **+{amount} {emoji}** grâce à ton vote.",
      weight: "Poids du vote",
      balance: "Balance",
      error: "Erreur vote Top.gg."
    },
    shop: {
      ...
      error: "Erreur shop.",
      userShopsDisabled: "Les boutiques membres sont désactivées sur ce serveur.",
      userShopNone: "{user} n'a pas de boutique.",
      userShopBot: "Les bots n'ont pas de boutique."
    },
    leaderboard: {
      title: "Leaderboard",
    ...
    game: {
      ...
      betInvalid: "Mise invalide. Entre un montant valide.",
      maxBet: "La mise maximale est de {max} {emoji}.",
      minBet: "La mise minimale est de {min} {emoji}.",
      insufficientFunds: "Solde insuffisant pour cette mise.",
      cooldown: "Ce jeu est encore en cooldown.",
      disabled: "Ce jeu est désactivé.",
  ...
  en: {
    ...
    commands: {
      ...
      giveMoneyAdminOnly: "Only administrators can use this command.",
      sensitiveCommandDeniedAdminOnly: "Only administrators can use this sensitive command.",
      sensitiveCommandDeniedWithRole: "Only administrators or the {role} role can use this sensitive command.",
      giveMoneyInvalidAmount: "Amount must be a positive integer.",
      giveMoneyBot: "You cannot give money to a bot.",
      giveMoneyRecipientMaxBalance: "Recipient has reached the maximum allowed balance.",
      giveMoneyEconomyDisabled: "Economy is disabled on this server.",
      giveMoneyRecipientBalance: "Recipient balance",
      addMoneySuccessTitle: "Money added",
      addMoneySuccessBody: "You added **{amount} {emoji}** to {user}.",
      addMoneyFailed: "Unable to add money right now."
    },
    daily: {
    ...
    vote: {
      linkTitle: "Vote on Top.gg",
      linkBody: "Support EcoBoty by voting, then use `/vote claim` on this server to get your reward.\n{url}",
      openButton: "Vote on Top.gg",
      reward: "Base reward",
      status: "Status",
      statusClaimable: "Reward available — `/vote claim`",
      statusNeedVote: "No claimable vote yet",
      needTitle: "Vote required",
      needBody: "Vote on Top.gg first, then come back to claim here.\n{url}",
      alreadyTitle: "Already claimed",
      alreadyBody: "You already claimed the reward for your latest vote on a server.",
      expiredTitle: "Vote expired",
      expiredBody: "Your vote is no longer valid. Vote again on Top.gg.\n{url}",
      disabledTitle: "Rewards disabled",
      disabledBody: "Top.gg rewards are temporarily disabled.",
      claimedTitle: "Top.gg reward",
      claimedBody: "You received **+{amount} {emoji}** from your vote.",
      weight: "Vote weight",
      balance: "Balance",
      error: "Top.gg vote error."
    },
    shop: {
      ...
      error: "Shop error.",
      userShopsDisabled: "Member shops are disabled on this server.",
      userShopNone: "{user} has no shop.",
      userShopBot: "Bots don't have shops."
    },
    buy: {
    ...
    game: {
      ...
      betInvalid: "Invalid bet. Enter a valid amount.",
      maxBet: "The maximum bet is {max} {emoji}.",
      minBet: "The minimum bet is {min} {emoji}.",
      insufficientFunds: "Insufficient balance for this bet.",
      cooldown: "This game is still on cooldown.",
      disabled: "This game is disabled.",
      detailResult: "Result",
      detailDie: "Die",
      detailColor: "Color",
  ...
  es: {
    ...
    commands: {
      ...
      sensitiveCommandDeniedAdminOnly: "Solo los administradores pueden usar este comando sensible.",
      sensitiveCommandDeniedWithRole: "Solo los administradores o el rol {role} pueden usar este comando sensible.",
      giveMoneyInvalidAmount: "La cantidad debe ser un entero positivo.",
      giveMoneyBot: "No puedes dar dinero a un bot.",
      giveMoneyRecipientMaxBalance: "El destinatario alcanzó el saldo máximo permitido.",
      giveMoneyEconomyDisabled: "La economía está desactivada en este servidor.",
      giveMoneyRecipientBalance: "Saldo del destinatario",
      addMoneySuccessTitle: "Dinero añadido",
      addMoneySuccessBody: "Has añadido **{amount} {emoji}** a {user}.",
      addMoneyFailed: "No se pudo añadir el dinero por ahora."
    },
    daily: {
    ...
    vote: {
      linkTitle: "Votar en Top.gg",
      linkBody: "Apoya EcoBoty votando y luego usa `/vote claim` en este servidor para reclamar tu recompensa.\n{url}",
      openButton: "Votar en Top.gg",
      reward: "Recompensa base",
      status: "Estado",
      statusClaimable: "Recompensa disponible — `/vote claim`",
      statusNeedVote: "Aún no hay voto para reclamar",
      needTitle: "Se requiere voto",
      needBody: "Vota primero en Top.gg y vuelve a reclamar aquí.\n{url}",
      alreadyTitle: "Ya reclamado",
      alreadyBody: "Ya reclamaste la recompensa de tu último voto en un servidor.",
      expiredTitle: "Voto expirado",
      expiredBody: "Tu voto ya no es válido. Vuelve a votar en Top.gg.\n{url}",
      disabledTitle: "Recompensas desactivadas",
      disabledBody: "Las recompensas de Top.gg están temporalmente desactivadas.",
      claimedTitle: "Recompensa Top.gg",
      claimedBody: "Has recibido **+{amount} {emoji}** por tu voto.",
      weight: "Peso del voto",
      balance: "Saldo",
      error: "Error de voto Top.gg."
    },
    shop: {
      ...
      userShopsDisabled: "Las tiendas de miembros están desactivadas en este servidor.",
      userShopNone: "{user} no tiene tienda.",
      userShopBot: "Los bots no tienen tienda."
    },
    buy: {
    ...
    game: {
      ...
      betInvalid: "Apuesta no válida. Introduce un importe válido.",
      maxBet: "La apuesta máxima es {max} {emoji}.",
      minBet: "La apuesta mínima es {min} {emoji}.",
      insufficientFunds: "Saldo insuficiente para esta apuesta.",
      cooldown: "Este juego sigue en enfriamiento.",
      disabled: "Este juego está desactivado.",
...
export const getBotSettings = async (guildId, apiBase, apiKey) => {
  ...
  try {
    ...
    const value = {
      ...
      sensitive_commands_role_id: data?.sensitive_commands_role_id || null,
    ...
    const value = {
      language: "fr",
      timezone: null,
      sensitive_commands_role_id: null,
      welcome_enabled: true,
      welcome_message_fr: null,
      welcome_message_en: null,
      welcome_message_es: null
